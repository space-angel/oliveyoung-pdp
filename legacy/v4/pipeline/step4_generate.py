...
INPUT_PATH = Path(__file__).parents[3] / "data/intermediate/step3_classified.json"
INPUT_GROUPED = Path(__file__).parents[3] / "data/intermediate/step0_grouped.json"
OUTPUT_PATH = Path(__file__).parents[3] / "data/output/concerns_v4.json"
PROMPT_PATH = Path(__file__).parent / "prompts/step4/v1.md"
